...
**size** | **string** | Required. Trading quantity. Positive for buy, negative for sell. Set to 0 for close position orders. | [default to undefined]
**iceberg** | **string** | Display size for iceberg orders. 0 for non-iceberg orders. Note that hidden portions are charged taker fees. | [optional] [default to undefined]
**price** | **string** | Required. Order Price; a price of 0 with &#x60;tif&#x60; as &#x60;ioc&#x60; represents a market order. | [default to undefined]
