...
> Promise<{ response: http.IncomingMessage; body: GetMyActivityEntryResponse; }> getMyActivityEntry()
...
const api = new GateApi.ActivityApi(client);
...
Promise<{ response: AxiosResponse; body: GetMyActivityEntryResponse; }> [GetMyActivityEntryResponse](GetMyActivityEntryResponse.md)
...
> Promise<{ response: http.IncomingMessage; body: ListActivitiesResponse; }> listActivities(opts)
...
Promise<{ response: AxiosResponse; body: ListActivitiesResponse; }> [ListActivitiesResponse](ListActivitiesResponse.md)
...
> Promise<{ response: http.IncomingMessage; body: ListActivityTypesResponse; }> listActivityTypes()
...
Promise<{ response: AxiosResponse; body: ListActivityTypesResponse; }> [ListActivityTypesResponse](ListActivityTypesResponse.md)
