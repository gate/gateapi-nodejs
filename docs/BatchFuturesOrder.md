...
**size** | **string** | Required. Trading quantity. Positive for buy, negative for sell. Set to 0 for close position orders. | [optional] [default to undefined]
...
**marketOrderSlipRatio** | **string** | The maximum slippage ratio | [optional] [default to undefined]
