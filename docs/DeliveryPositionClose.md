...
**maxSize** | **number** | Max Trade Size | [optional] [readonly] [default to undefined]
**accumSize** | **number** | Cumulative closed position volume | [optional] [readonly] [default to undefined]
...
## Enum: DeliveryPositionClose.Side
