...
**accountMode** | **string** | Account mode. CROSS_EXCHANGE: cross-exchange mode. ISOLATED_EXCHANGE: isolated exchange mode | [optional] [default to undefined]
**exchangeType** | **string** | Exchange type. When account_mode is CROSS_EXCHANGE, this must be CROSSEX; otherwise, it represents a specific exchange | [optional] [default to undefined]
**assets** | [**Array&lt;InlineResponse20032Assets&gt;**](InlineResponse20032Assets.md) |  | [default to undefined]
