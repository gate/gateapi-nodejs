...
export class InlineObject12 {
     ...
     */
    'timeInForce'?: InlineObject12.TimeInForce;
    /**
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            ...
            type: 'InlineObject12.TimeInForce',
        },
        {
            name: 'qty',
            baseName: 'qty',
        ...
        },
        {
            ...
            type: 'InlineObject12.ReduceOnly',
        },
        {
            name: 'positionSide',
            baseName: 'position_side',
            type: 'InlineObject12.PositionSide',
        },
    ];
