...
export class InlineObject22 {
     ...
     */
    'timeInForce'?: InlineObject22.TimeInForce;
    /**
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            ...
            type: 'InlineObject22.TimeInForce',
        },
        {
            name: 'qty',
            baseName: 'qty',
        ...
        },
        {
            ...
            type: 'InlineObject22.ReduceOnly',
        },
        {
            name: 'positionSide',
            baseName: 'position_side',
            type: 'InlineObject22.PositionSide',
        },
    ];
...
export namespace InlineObject22 {
    export enum Side {
        BUY = <any>'BUY',
        SELL = <any>'SELL',
    }
