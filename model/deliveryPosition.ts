...
export class DeliveryPosition {
    ...
    static getAttributeTypeMap() {
        return DeliveryPosition.attributeTypeMap;
    }
}

export namespace DeliveryPosition {
    export enum Mode {
        Single = <any>'single',
