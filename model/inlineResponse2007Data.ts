...
export class InlineResponse2007Data {
     ...
     */
    'status'?: InlineResponse2007Data.Status;
     ...
     */
    'isTaskCoupon'?: InlineResponse2007Data.IsTaskCoupon;
    /**
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            name: 'status',
            baseName: 'status',
            type: 'InlineResponse2007Data.Status',
        },
        {
            name: 'jumpUrl',
            baseName: 'jump_url',
        ...
        },
        {
            ...
            type: 'InlineResponse2007Data.IsTaskCoupon',
        },
        {
            name: 'upgradeToast',
...
export namespace InlineResponse2007Data {
    export enum Status {
